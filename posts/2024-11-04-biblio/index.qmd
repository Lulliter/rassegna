...
+ **MITIGAZIONE dei cambiamenti climatici** presuppone che: 1) abbiamo capito esattamente quali sono le cause e 2) è in nostro potere fare qualcosa per ridurli. Due cose che però non sono affatto dimostrate. Ad esempio:
...
+ **ADATTAMENTO ai cambiamenti climatici** presuppone che: 1) i cambiamenti climatici siano in corso e 2) non possiamo fare nulla per ridurli, ma possiamo investire risorse per prevedere ed difenderci dai rischi. Ad esempio:
  - Gestire boschi e foreste con manutenzione e pulizia
  - Gestire il rischio idrogeologico (esondazioni e frane) con opere di ingegneria civile e idraulica
